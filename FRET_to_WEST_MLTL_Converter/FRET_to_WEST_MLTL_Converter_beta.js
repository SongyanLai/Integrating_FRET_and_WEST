...
const result = fretToMltlConverter(
  "((LAST V (((! ((param_V > paramMax_V) | (param_V < paramMin_V))) & ((! LAST) & (X ((param_V > paramMax_V) | (param_V < paramMin_V))))) -> (X (LAST | (X paramAlarm_V))))) & (((param_V > paramMax_V) | (param_V < paramMin_V)) -> (LAST | (X paramAlarm_V))))" //example FRET formula
);
